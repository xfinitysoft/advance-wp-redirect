...
function xsawrlite_page(){
	$tab = isset($_GET['tab']) ? $_GET['tab']: 'Easy Redirect';
	?>
	<div class="xsawrlite">
		<div class="mdl-grid">
			...
			<div class='mdl-cell mdl-cell--12-col mdl-cell--4-offset'>
				<h3><?php esc_html_e("Advance WP Redirect" , XSAWRLITE_DOMAIN) ?>
		...
		<div class="mdl-tabs mdl-js-tabs mdl-js-ripple-effect">
			<div class="mdl-tabs__tab-bar xsawrlite-tabs nav-tab-wrapper">
				<a href="?page=xsawrlite_page&tab=Easy Redirect" class="mdl-tabs__tab <?php  ($tab == 'Easy Redirect') ? 'is-active' :'' ; ?>">
					<?php esc_html_e( 'Easy Redirect' , XSAWRLITE_DOMAIN ) ;?>
				</a>
				<a href="?page=xsawrlite_page&tab=Options" class="mdl-tabs__tab <?php  $tab == 'Options' ? 'is-active' :'' ; ?>">
					<?php esc_html_e( 'Options' , XSAWRLITE_DOMAIN ); ?>		
				</a>
			</div>
			<?php
			if( $tab == 'Easy Redirect' ) {
				include_once XSAWRLITE_ABSPATH . '/templates/xsawrlite-easy-redirect.php'; 
			}
			
			if( $tab == 'Options' ):?>
				<div class="mdl-tabs__panel <?php esc_html_e( $tab == 'Options' ? 'is-active' :'' ) ?>" id="xsawrlite-options">
